...
//    "(ID" "INT(11)" "NOTNULL" "AUTOINCREMENT,LASTNAME" "VARCHAR(255)" "DEFAULTNULL,GENDER" "CHAR(1)" "DEFAULT" "NULL)"
    ...
    public static boolean havePoint(String str){
        return str.split("\\.").length!=1;
    }

    public static String[] getPointArray(String str){
        return str.split("\\.");
    }
     ...
     * @return boolean
     */
    public static int checkExist(ArrayList<ColumnAttributes> columnNameArrayList, String columnName) {
